...
*/
   ...
   private void locateEntities() { //Places all entities and stationaries into locations
      ...
      for(int i = 0; i < entities.size(); i++) {
         if	(entities.get(i).getX() == 0 || entities.get(i).getY() == 0) {
            out.println("Error: " + entities.get(i).getName() + " does not have any coordinates.");
         }
         else {
            locations[entities.get(i).getX()][entities.get(i).getY()] = entities.get(i);
         } 
      }
      for(int i = 0; i < stationaries.size(); i++) {
         if	(stationaries.get(i).getX() == 0 || stationaries.get(i).getY() == 0) {
            out.println("Error: " + stationaries.get(i).getName() + " does not have any coordinates.");
         }
         else if (locations[stationaries.get(i).getX()][stationaries.get(i).getY()] == placeholder) { //Doesn't allow stationaries to override entities
            locations[stationaries.get(i).getX()][stationaries.get(i).getY()] = stationaries.get(i);
         }
         else if (locations[stationaries.get(i).getX()][stationaries.get(i).getY()] instanceof Player) {
            if (stationaries.get(i) instanceof Doorway) {
               currentOverlap = (Doorway) stationaries.get(i);
               playerOn = 1;
               allcheck = true;
            }
            if (stationaries.get(i) instanceof Healer) {
               currentOverlap = (Healer) stationaries.get(i);
               playerOn = 2;
               allcheck = true;
            }
            if (stationaries.get(i) instanceof Chest) {
               currentOverlap = (Chest) stationaries.get(i);
               playerOn = 3;
               allcheck = true;
            }
         }
   ...
   private void locateEntity(Entity e,int dir) { //Before a move finishes, it checks if the
      ...
      else if ((e instanceof Player) && (locations[e.getX()][e.getY()] instanceof Healer)) { //There's a healer, heal player
      ...
      else if ((e instanceof Player) && (locations[e.getX()][e.getY()] instanceof Chest)) {
   ...
   public void moveRight(Entity e) {
      ...
      //locations[e.getX()][e.getY()] = placeholder;        
         ...
         locateEntity(entities.get(loc),2);
      }
      else {
         out.println("Error: cannot move in that direction");
      }
   ...
   public void moveLeft(Entity e) {
      ...
      //locations[e.getX()][e.getY()] = placeholder;  
         entities.get(loc).changeX(-1);
         locateEntity(entities.get(loc),4);
      }
      else {
         out.println("Error: cannot move in that direction");
      }
   ...
   public void moveUp(Entity e) {
      ...
      //locations[e.getX()][e.getY()] = placeholder;  
         ...
         locateEntity(entities.get(loc),1);
      }
      else {
         out.println("Error: cannot move in that direction");
      }
   ...
   public void moveDown(Entity e) {
      ...
      //locations[e.getX()][e.getY()] = placeholder;  
         entities.get(loc).changeY(1);
         locateEntity(entities.get(loc),3);
      }
      else {
         out.println("Error: cannot move in that direction");
      }
